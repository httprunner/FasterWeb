<template>
    <div>
        ...
        <div class="request" style="height: 1000px; overflow:scroll;">
            ...
            <el-tabs
                style="margin-left: 20px;height:1000px; overflow:scroll;"
                v-model="activeTag"
            >
                ...
                <el-tab-pane label="变量抽取" name="third">
                    <extract
                        :save="save"
                ...
                <el-tab-pane label="校验" name="fourth">
                    <validate
                        :save="save"
